...
from keras.layers import Input, Embedding, Bidirectional, LSTM, Lambda, Subtract, Dense, Dropout, GlobalAveragePooling1D
import keras.backend as K

"""
Siamese Bidirectional LSTM as described by Neculoiu, Versteegh, and Rotaru (2016).
Modifications made to also handle Manhattan Distance, based on equation from Shirkhorshidi, Aghabozorgi, Wah (2015).
"""
...
class BiLSTM(Model):
    ...
    def call(self, inputs):
        ...
        left_bilstm_1 = self.stacked_bilstm_start(encoded_left)
        right_bilstm_1 = self.stacked_bilstm_start(encoded_right)
